...
from src.main_page import (exchange_rate, get_card_details, greeting_user_input, stocks_from_the_SP500,
...
def test_exchange_rate_with_valid_currencies():
    ...
    mock_response.json.return_value = {"exchange_rates": {"RUB": 75.00, "USD": 1.00, "EUR": 0.90}}
...
def test_stocks_from_the_SP500_with_valid_stocks():
    ...
    mock_response = Mock()
    mock_response.status_code = 200
    mock_response.json.return_value = {"data": [{"low": 100.00}]}
